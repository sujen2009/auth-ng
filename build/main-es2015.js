...
let AuthenticationService = class AuthenticationService {
    ...
    login(username, password) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/auth`, { username, password })
        ...
        return new Promise((resolve, reject) => {
            FB.login(result => {
                if (result.authResponse) {
                    return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/auth/facebook`, { access_token: result.authResponse.accessToken })
                        .toPromise()
                        .then((response) => {
...
/* harmony import */ var ngx_cookie__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-cookie */ "./node_modules/ngx-cookie/fesm2015/ngx-cookie.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ngx_cookie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-cookie */ "./node_modules/ngx-cookie/fesm2015/ngx-cookie.js");
...
let AuthenticationGuard = class AuthenticationGuard {
     ...
     */
    redirectToMainApp() {
        const redirectUrl = `${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].mainApp}`;
...
let LoginComponent = class LoginComponent {
    constructor(route, router, fbAuthService, authenticationService) {
        this.route = route;
        this.router = router;
